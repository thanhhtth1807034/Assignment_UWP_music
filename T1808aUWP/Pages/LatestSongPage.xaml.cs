...
namespace T1808aUWP.Pages
{
    ...
    public sealed partial class LatestSongPage : Page
    {
        private const string GetLatestSong = "https://2-dot-backup-server-003.appspot.com/_api/v2/songs";
        private List<Song> _listSongs;
        private int _currentIndex = 0;
        private bool _isPlaying;
        private DispatcherTimer _playTimer;
        public LatestSongPage()
        {
        ...
        private async void ReadTokenFromFile()
        {
            ...
            try
            {
                ...
                if (storageFile != null)
                {
                    ...
                    var httpWebRequest = (HttpWebRequest)WebRequest.Create(string.Format(GetLatestSong));
